...
def _get_excluded_pairs(df_ws_validations, df_ws_stereotypes, annotator_id):
    ...
    return validation_pairs.union(stereotype_pairs)
...
def select_data_point(
    ...
    excluded_pairs = _get_excluded_pairs(
        df_ws_validations, df_ws_stereotypes, annotator_id
    )
